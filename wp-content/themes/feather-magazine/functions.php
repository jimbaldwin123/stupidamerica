...
if ( ! function_exists( 'feather_magazine_readmore' ) ) {
    ...
    function feather_magazine_readmore() {
      ?>
      <div class="readMore">
        <a href="<?php echo esc_url( get_the_permalink() ); ?>" title="<?php the_title_attribute(); ?>" style="color:#396;background-color: #fff;">
  ...
  <div class="wrap about-wrap feather-magazine-add-css">
    <div>
      ...
      <div class="feature-section three-col">
        ...
        <div class="col">
          <div class="widgets-holder-wrap">
            <h3><?php echo esc_html_e("Review Feather Magazine", "feather-magazine"); ?></h3>
            <p><?php echo esc_html_e("Nothing motivates us more than feedback, are you are enjoying Feather Magazine? We would love to hear what you think!", "feather-magazine"); ?></p>
            <p><a target="blank" href="<?php echo esc_url('https://wordpress.org/support/theme/feather-magazine/reviews/?filter=5', 'feather-magazine'); ?>" class="button button-primary">
              <?php echo esc_html_e("Submit A Review", "feather-magazine"); ?>
            </a></p>
          </div>
        </div>
        <div class="col">
